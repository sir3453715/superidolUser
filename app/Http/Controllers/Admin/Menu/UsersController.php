...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->get('keyword')) {
            ...
            $users = $users->where(function ($query) use ($queried){
    ...
    public function create()
    {
        if(Auth::user()->hasRole('administrator')) {
            ...
            $roles = Role::where('name','!=','administrator','manager')
                ->orderBy('id','ASC')
                ->get();
        }else{
            $roles = Role::whereNotIn('name',['administrator','manager','member'])
                ->orderBy('id','ASC')
                ->get();
        }
    ...
    public function edit($id)
    {
        ...
        $carDatas = CarData::where('user_id',$user->id)->orderBy('created_at','DESC')->get();
